...
import CurrentDate from "./DashboardAnalyticsHeaderDate";

function DashboardAnalyticsHeader() {
  return (
    <div className="dashboard-analytics-header">
      <div className="dashboard-analytics-header-head">
        <h1 className="dashboard-analytics-header-head-dashboard">Dashboard</h1>
        <p className="dashboard-analytics-header-head-date">
          <CurrentDate />
        </p>
      </div>
      <hr className="dashboard-analytics-header-head-line" />
